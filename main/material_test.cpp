...
namespace gpr5300
{
	...
	private:
		...
		std::string_view cubeVert = "data/shaders/hello_triangle/material.vert";
		std::string_view cubeFrag = "data/shaders/hello_triangle/material.frag";
	...
	void Test::Update(float dt)
	{
		...
		auto model = glm::rotate(camera_.model_, tt_ * glm::radians(50.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		//set material spec
		pipelinecube_.SetVec3("material.ambient", 1.0f, 0.5f, 0.31f);
		pipelinecube_.SetVec3("material.diffuse", 1.0f, 0.5f, 0.31f);
		pipelinecube_.SetVec3("material.specular", 0.5f, 0.5f, 0.5f);
		...
		pipelinecube_.SetVec3("light.position", lightPos_);
		CheckError(__FILE__, __LINE__);
